...
/*
 * There are three scenarios, in which parvo_neuron_module can be loaded by NEST:
 *
...
mynest::parvo_neuron_module parvo_neuron_module_LTX_mod;
#endif
// -- DynModule functions ------------------------------------------------------

mynest::parvo_neuron_module::parvo_neuron_module()
{
#ifdef LINKED_MODULE
...
const std::string
mynest::parvo_neuron_module::name( void ) const
{
  return std::string( "My NEST Module" ); // Return name of the module
}

const std::string
mynest::parvo_neuron_module::commandstring( void ) const
{
  // Instruct the interpreter to load parvo_neuron_module-init.sli
  return std::string( "(parvo_neuron_module-init) run" );
}

//-------------------------------------------------------------------------------------

void
mynest::parvo_neuron_module::init( SLIInterpreter* i )
{
  /* Register a neuron or device model.
     Give node type as template argument and the name as second argument.
  */
  nest::kernel().model_manager.register_node_model< parvo_neuron >(
    "parvo_neuron" );


} // parvo_neuron_module::init()
