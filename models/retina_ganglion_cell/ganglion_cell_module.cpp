...
#include "ganglion_cell_module.h"
...
/*
 * There are three scenarios, in which ganglion_cell_module can be loaded by NEST:
 *
...
mynest::ganglion_cell_module ganglion_cell_module_LTX_mod;
#endif
// -- DynModule functions ------------------------------------------------------

mynest::ganglion_cell_module::ganglion_cell_module()
{
#ifdef LINKED_MODULE
...
const std::string
mynest::ganglion_cell_module::name( void ) const
{
  return std::string( "My NEST Module" ); // Return name of the module
}

const std::string
mynest::ganglion_cell_module::commandstring( void ) const
{
  // Instruct the interpreter to load ganglion_cell_module-init.sli
  return std::string( "(ganglion_cell_module-init) run" );
}

//-------------------------------------------------------------------------------------

void
mynest::ganglion_cell_module::init( SLIInterpreter* i )
{
  /* Register a neuron or device model.
     Give node type as template argument and the name as second argument.
  */
  nest::kernel().model_manager.register_node_model< ganglion_cell >(
    "ganglion_cell" );


} // ganglion_cell_module::init()
